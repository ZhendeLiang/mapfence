(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'leaflet')) {
            inputCSS("/css/leaflet.css");
            inputScript("/js/leaflet.js");
        }
        ...
        if (inArray(includes, 'deck')) {
            inputScript("/js/deck.gl.min.js");
        }
        if (inArray(includes, 'xlsx')) {
            inputScript("/js/xlsx.core.min.js");
        }
        ...
        if (inArray(includes, 'iclient9-plot-leaflet')) {
            inputCSS("/css/iclient9-plot-leaflet.css");
            inputScript("/js/iclient9-plot-leaflet.min.js");
        }
