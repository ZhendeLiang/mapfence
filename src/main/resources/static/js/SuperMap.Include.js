(function() {
    ...
    //加载类库资源文件
    function loadSMLibs() {
        inputScript(baseurl+'SuperMap-8.1.1-16520.js');
        inputScript(baseurl+'SuperMap_Plot-8.1.1-16520.js');
        loadLocalization();
        inputCSS('/theme/default/style.css');
        inputCSS('/theme/default/google.css');
    }
    //引入汉化资源文件
